...
class Runner:
    ...
    def register_gitlab_variables(self, level, *args):
    ...
    def register_gitlab_group_variables(self, *args):
        """Register one or more GitLab group variable."""
        self.register_gitlab_variables("group", *args)

    def register_gitlab_project_variables(self, *args):
        """Register one or more GitLab project variable."""
        self.register_gitlab_variables("project", *args)
    ...
    def register_tfvars(self, tf_stage, *args):
